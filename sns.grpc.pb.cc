...
static const char* SNSService_method_names[] = {
  ...
  "/csce662.SNSService/ClientHeartbeat",
...
SNSService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_ClientHeartbeat_(SNSService_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status SNSService::Stub::ClientHeartbeat(::grpc::ClientContext* context, const ::csce662::Request& request, ::csce662::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce662::Request, ::csce662::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_ClientHeartbeat_, context, request, response);
}

void SNSService::Stub::async::ClientHeartbeat(::grpc::ClientContext* context, const ::csce662::Request* request, ::csce662::Reply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce662::Request, ::csce662::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ClientHeartbeat_, context, request, response, std::move(f));
}

void SNSService::Stub::async::ClientHeartbeat(::grpc::ClientContext* context, const ::csce662::Request* request, ::csce662::Reply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ClientHeartbeat_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::csce662::Reply>* SNSService::Stub::PrepareAsyncClientHeartbeatRaw(::grpc::ClientContext* context, const ::csce662::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce662::Reply, ::csce662::Request, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_ClientHeartbeat_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce662::Reply>* SNSService::Stub::AsyncClientHeartbeatRaw(::grpc::ClientContext* context, const ::csce662::Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncClientHeartbeatRaw(context, request, cq);
  result->StartCall();
  return result;
}
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< SNSService::Service, ::csce662::Request, ::csce662::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SNSService::Service* service,
             ...
             const ::csce662::Request* req,
             ::csce662::Reply* resp) {
               return service->ClientHeartbeat(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status SNSService::Service::ClientHeartbeat(::grpc::ServerContext* context, const ::csce662::Request* request, ::csce662::Reply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
